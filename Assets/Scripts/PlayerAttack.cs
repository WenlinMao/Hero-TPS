...
public class PlayerAttack : MonoBehaviour {
    ...
    void shoot()
	{
        ...
        {
			//当被击中的游戏对象标签为Enemy，或者名字包含zombie(hitInfo.collider.gameObject.name.Contains("Zombie"))，或者包含enemyhealth script，
			//表明射线射中敌人
			if (hitInfo.collider.gameObject.GetComponent<EnemyHealth>() != null || hitInfo.collider.gameObject.tag == "Enemy")	
            {
